...
e.preventDefault();}});function setTeamMemberHeight(){$('.music-banner').height($('.music-banner').width());$('.music-banner-image').height($('.music-banner-image').width());$('.news_bg_image').height($('.news_bg_image').width());$('.disc-image').height($('.music-banner-image').width()-30);$('.disc-image').width($('.disc-image').height());}
...
'                    <img src="resources/images/andre-benz.png" alt="Andre Benz"/>\n'+
'                </div>\n'+
